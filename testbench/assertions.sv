...
module assertions (
   ...
   // Aserción conflicto de instrucciones. No puede estarse cargando ninguna instrucción en FLUSH
   ...
   check_rd_and_lcc_valid_status: assert property (@(posedge CLK) disable iff (RES) (`RTL_PATH.RD == 1) |-> (`RTL_PATH.LCC == 1)); //(`RTL_PATH.LCC == 1) & (`RTL_PATH.HLT == 1)
